...
class ApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_expire_notification.html'
    txt_template = 'boranga/emails/approval_expire_notification.txt'
...
class FilmingLawfulAuthorityApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_lawful_authority_expire_notification.html'
    txt_template = 'boranga/emails/approval_lawful_authority_expire_notification.txt'

class FilmingLicenceApprovalExpireNotificationEmail(TemplateEmailBase):
    subject = '{} - Commercial Filming Lawful Authoriy expired.'.format(settings.DEP_NAME)
    html_template = 'boranga/emails/approval_filming_expire_notification.html'
    txt_template = 'boranga/emails/approval_filming_expire_notification.txt'
...
class ApprovalCancelNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_cancel_notification.html'
    txt_template = 'boranga/emails/approval_cancel_notification.txt'
...
class ApprovalSuspendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_suspend_notification.html'
    txt_template = 'boranga/emails/approval_suspend_notification.txt'
...
class ApprovalSurrenderNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_surrender_notification.html'
    txt_template = 'boranga/emails/approval_surrender_notification.txt'
...
class ApprovalReinstateNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_reinstate_notification.html'
    txt_template = 'boranga/emails/approval_reinstate_notification.txt'
...
class ApprovalRenewalNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_renewal_notification.html'
    txt_template = 'boranga/emails/approval_renewal_notification.txt'
...
class ApprovalEclassRenewalNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_eclass_renewal_notification.html'
    txt_template = 'boranga/emails/approval_eclass_renewal_notification.txt'
...
class ApprovalEclassExpiryNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/approval_eclass_expiry_notification.html'
    txt_template = 'boranga/emails/approval_eclass_expiry_notification.txt'
...
def _log_approval_email(email_message, approval, sender=None):
    from boranga.components.approvals.models import ApprovalLogEntry
