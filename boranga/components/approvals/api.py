...
from boranga.components.proposals.models import Proposal, ApplicationType
from boranga.components.approvals.models import (
    Approval,
    ApprovalDocument
)
from boranga.components.approvals.serializers import (
    ApprovalSerializer,
...
class ApprovalPaginatedViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        if is_internal(self.request):
            ...
            user_orgs = [org.id for org in self.request.user.boranga_organisations.all()]
