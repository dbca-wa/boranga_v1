...
from boranga.components.main.models import UserAction,CommunicationsLogEntry, Document
from boranga.components.organisations.utils import random_generator, can_admin_org, has_atleast_one_admin
...
class Organisation(models.Model):
    ...
    delegates = models.ManyToManyField(EmailUser, blank=True, through='UserDelegation', related_name='boranga_organisations')
...
class OrganisationRequest(models.Model):
    ...
    def __accept(self,request):
        ...
        # Create Organisation in boranga
