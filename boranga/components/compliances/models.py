...
class Compliance(RevisionedMixin):
    ...
    proposal = models.ForeignKey('boranga.Proposal',related_name='compliances')
    approval = models.ForeignKey('boranga.Approval',related_name='compliances')
    ...
    assigned_to = models.ForeignKey(EmailUser,related_name='boranga_compliance_assignments',null=True,blank=True)
    ...
    submitter = models.ForeignKey(EmailUser, blank=True, null=True, related_name='boranga_compliances')
