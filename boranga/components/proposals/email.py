...
class QAOfficerSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_qaofficer_notification.html'
    txt_template = 'boranga/emails/proposals/send_qaofficer_notification.txt'

class QAOfficerCompleteNotificationEmail(TemplateEmailBase):
    subject = 'A QA for an application has been completed.'
    html_template = 'boranga/emails/proposals/send_qaofficer_complete_notification.html'
    txt_template = 'boranga/emails/proposals/send_qaofficer_complete_notification.txt'

class ReferralSendNotificationEmail(TemplateEmailBase):
    subject = 'A referral for an application has been sent to you.'
    html_template = 'boranga/emails/proposals/send_referral_notification.html'
    txt_template = 'boranga/emails/proposals/send_referral_notification.txt'
...
class ReferralFilmingSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_filming_referral_notification.html'
    txt_template = 'boranga/emails/proposals/send_filming_referral_notification.txt'

class ReferralCompleteNotificationEmail(TemplateEmailBase):
    subject = 'A referral for an application has been completed.'
    html_template = 'boranga/emails/proposals/send_referral_complete_notification.html'
    txt_template = 'boranga/emails/proposals/send_referral_complete_notification.txt'

class ProposalDeclineSendNotificationEmail(TemplateEmailBase):
    subject = 'Your Application has been declined.'
    html_template = 'boranga/emails/proposals/send_decline_notification.html'
    txt_template = 'boranga/emails/proposals/send_decline_notification.txt'
...
class ProposalApprovalSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_approval_notification.html'
    txt_template = 'boranga/emails/proposals/send_approval_notification.txt'

class ProposalFilmingApprovalSendNotificationEmail(TemplateEmailBase):
    subject = '{} - Commercial Operations Licence Approved.'.format(settings.DEP_NAME)
    html_template = 'boranga/emails/proposals/send_filming_approval_notification.html'
    txt_template = 'boranga/emails/proposals/send_filming_approval_notification.txt'

class ProposalEventApprovalSendNotificationEmail(TemplateEmailBase):
    subject = '{} - Commercial Operations Licence Approved.'.format(settings.DEP_NAME)
    html_template = 'boranga/emails/proposals/send_event_approval_notification.html'
    txt_template = 'boranga/emails/proposals/send_event_approval_notification.txt'
...
class ProposalAwaitingPaymentApprovalSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_awaiting_payment_approval_notification.html'
    txt_template = 'boranga/emails/proposals/send_awaiting_payment_approval_notification.txt'
...
class AmendmentRequestSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_amendment_notification.html'
    txt_template = 'boranga/emails/proposals/send_amendment_notification.txt'
...
class SubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_submit_notification.html'
    txt_template = 'boranga/emails/proposals/send_submit_notification.txt'
...
class ExternalSubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_external_submit_notification.html'
    txt_template = 'boranga/emails/proposals/send_external_submit_notification.txt'

class ApproverDeclineSendNotificationEmail(TemplateEmailBase):
    subject = 'An Application has been recommended for decline.'
    html_template = 'boranga/emails/proposals/send_approver_decline_notification.html'
    txt_template = 'boranga/emails/proposals/send_approver_decline_notification.txt'

class ApproverApproveSendNotificationEmail(TemplateEmailBase):
    subject = 'An Application has been recommended for approval.'
    html_template = 'boranga/emails/proposals/send_approver_approve_notification.html'
    txt_template = 'boranga/emails/proposals/send_approver_approve_notification.txt'

class ApproverSendBackNotificationEmail(TemplateEmailBase):
    subject = 'An Application has been sent back by approver.'
    html_template = 'boranga/emails/proposals/send_approver_sendback_notification.html'
    txt_template = 'boranga/emails/proposals/send_approver_sendback_notification.txt'
...
class DistrictProposalSubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_district_proposal_submit_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_proposal_submit_notification.txt'
...
class DistrictApproverSendBackNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_district_approver_sendback_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_approver_sendback_notification.txt'
...
class DistrictApproverDeclineSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_district_approver_decline_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_approver_decline_notification.txt'
...
class DistrictApproverApproveSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_district_approver_approve_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_approver_approve_notification.txt'

class DistrictProposalDeclineSendNotificationEmail(TemplateEmailBase):
    subject = 'Your Application has been declined.'
    html_template = 'boranga/emails/proposals/send_district_decline_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_decline_notification.txt'
...
class DistrictProposalApprovalSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'boranga/emails/proposals/send_district_approval_notification.html'
    #html_template = 'boranga/emails/proposals/send_district_decline_notification.html'
    txt_template = 'boranga/emails/proposals/send_district_approval_notification.txt'
...
def _log_proposal_referral_email(email_message, referral, sender=None):
    from boranga.components.proposals.models import ProposalLogEntry
...
def _log_org_email(email_message, organisation, customer ,sender=None):
    from boranga.components.organisations.models import OrganisationLogEntry
    if isinstance(email_message, (EmailMultiAlternatives, EmailMessage,)):
        # TODO this will log the plain text body, should we log the html instead
        text = email_message.body
        subject = email_message.subject
